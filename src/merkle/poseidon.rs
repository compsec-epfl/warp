...
mod tests {
    ...
    fn example_usage() {
        ...
        assert!(!proof0
            ...
            .unwrap());
        assert!(!proof1
            .verify(&leaf_hash_param, &one_two_hash_param, &mt.root(), leaf0)
            .unwrap());
    }
}
...
pub fn poseidon_test_params() -> PoseidonConfig<BLS12_381> {
    ...
    //  [0, 1, 1]]
    let mds = vec![
        vec![BLS12_381::one(), BLS12_381::zero(), BLS12_381::one()],
        vec![BLS12_381::one(), BLS12_381::one(), BLS12_381::zero()],
        vec![BLS12_381::zero(), BLS12_381::one(), BLS12_381::one()],
    ];
    PoseidonConfig::<BLS12_381>::new(full_rounds, partial_rounds, alpha, mds, ark, 2, 1)
}
