...
\paragraph{Paired Rust module.} \codemod{src/iop/oracles/evaluation.rs}, consumed
throughout \codemod{src/iop/iors/}.
...
\codemod{src/iop/oracles/evaluation.rs}.
...
caches. See \codemod{src/iop/oracles/evaluation.rs}, method \texttt{query\_at\_point}.
...
\begin{description}
  \item[Index query.] \(f[i]\) for \(i \in \idx{n}\). BCS-native.
        ...
        \codemod{src/iop/oracles/evaluation.rs}, method \texttt{query\_at\_leaf}.
  \item[Point query.] \(\MLE{f}(\zeta)\) for \(\zeta \in \F^{\log n}\).
        ...
        \codemod{src/iop/oracles/evaluation.rs}, method \texttt{query\_at\_point}.
\end{description}
...
In Rust this is literally one struct (\codemod{src/iop/oracles/evaluation.rs}).
